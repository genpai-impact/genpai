...
namespace GalForUnity.System{
    public class GfuLanguage{
        ...
        public readonly LanguageItem ROLECHECKNODE = new LanguageItem("Role Check Node","角色检查节点");
        public readonly LanguageItem SCENECHECKNODE = new LanguageItem("Scene Check Node","场景检查节点");
