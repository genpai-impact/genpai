...
namespace Genpai
{
    ...
    public class CardLibrary : Singleton<CardLibrary>
    {
        ...
        public void LoadFormFile()
        {
            ...
            int cardDeckId = 0;
            List<int> cardDeck = new List<int> { 100, 101, 102, 103, 300, 301, 303, 200, 201, 202, 203, 204, 205, 206, 207, 304, 305, 306};
            //List<int> cardDeck = new List<int> { 100,  };
            ...
            List<int> enemyCardDeck = new List<int> { 100, 101, 102, 103, 200, 201, 202, 203, 204, 205, 206, 207 };
