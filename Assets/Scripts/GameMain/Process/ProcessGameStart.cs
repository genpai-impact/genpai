...
namespace Genpai
{
    ...
    class ProcessGameStart : IProcess
    {
        ...
        public void Run()
        {
            ...
            List<int> cardIdList = new List<int> { 100, 101, 102, 103, 300, 301, 200, 201, 202, 203, 204, 205, 206, 207, 200, 201, 202, 203, 204, 205, 206, 207, 200, 201, 202, 203, 204, 205, 206, 207, 200, 201, 202, 203, 204, 205 };//测试
