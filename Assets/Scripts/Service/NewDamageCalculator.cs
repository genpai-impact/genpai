...
namespace Genpai
{
    ...
    /// 伤害计算器
    /// </summary>
    public partial class NewDamageCalculator : Singleton<NewDamageCalculator>
    {
        // 计算器线程锁
        ...
        public void Calculate(ref NewDamage damage)
        {
            lock (calculatorLock)
            {
        ...
        public ElementReactionEnum TakeReaction(NewDamage damage)
        {
            NewUnit target = damage.GetTarget();
            NewUnit source = damage.GetSource();
        ...
        public void CalculateReaction(ElementReactionEnum reaction, ref NewDamage damage)
        {
